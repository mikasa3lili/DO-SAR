...
def add_difficulty_to_annos(info):
    ...
    max_occlusion = [0, 1, 2]  # "zhe dang".maximum occlusion level of the groundtruth used for eval_utils
    max_trunc = [0.15, 0.3, 0.5]  # "jie duan". maximum truncation level of the groundtruth used for eval_utils
    annos = info['annos']
