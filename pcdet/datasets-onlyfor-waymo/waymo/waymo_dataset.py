...
if __name__ == '__main__':
    ...
    if args.func == 'create_waymo_infos':
        ...
        #ROOT_DIR = PosixPath('/data0/hx/dataset/waymo')
        dataset_cfg.PROCESSED_DATA_TAG = args.processed_data_tag
        create_waymo_infos(
            dataset_cfg=dataset_cfg,
            class_names=['Vehicle', 'Pedestrian', 'Cyclist'],
            data_path= PosixPath('/data0/hx/dataset/waymo'), #ROOT_DIR / 'data' / 'waymo',
            save_path= PosixPath('/data0/hx/dataset/waymo'), #ROOT_DIR / 'data' / 'waymo',
